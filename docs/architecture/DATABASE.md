...
*This document is the single source of truth for the Ambaril database schema. All schema changes must be reflected here before implementation. Update this document as part of every migration PR.*
