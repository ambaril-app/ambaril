...
**Nota de escopo:** este documento vale apenas para superfícies de marca (`ambaril.com` e login). A linguagem simbólica e o artefato de luz vivem aqui. Eles **não** autorizam fantasia, lore ou excesso de efeito nas telas operacionais do produto.
...
**Regra adicional:** atmosfera nunca pode vencer clareza comercial. Mesmo no hero, a página deve comunicar "um sistema para operar o negócio inteiro" antes de comunicar mistério.
...
O artefato central é o **Silmaril** — uma joia auto-luminosa que contém o espectro de luz dentro de si. Não é iluminada por fora: ela _é_ a fonte. O espectro prismático existe dentro da esfera; fora dela, a página é Moonstone puro.
...
Sem emoji. Sem urgência artificial. Sem promessa de prazo. A ausência de entusiasmo _é_ a mensagem.
...
**Limite:** o artefato é um ponto focal de marca, não uma estética replicável para o restante do produto. Sem transformar o sistema inteiro em "site conceitual".
