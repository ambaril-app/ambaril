...
// checkout.carts
export const carts = checkoutSchema
  .table(
    "carts",
    {
      id: uuid("id")
      ...
      total: numeric("total", { precision: 12, scale: 2 })
        .notNull()
        .default("0"),
      couponId: uuid("coupon_id"), // FK to coupons table (future creators module)
...
// checkout.cart_items
export const cartItems = checkoutSchema
  .table(
    "cart_items",
    {
      id: uuid("id")
...
// checkout.orders
export const orders = checkoutSchema
  .table(
    "orders",
    {
      id: uuid("id")
...
export const orderItems = checkoutSchema
  .table(
    "order_items",
    {
      id: uuid("id")
...
export const abandonedCarts = checkoutSchema
  .table(
    "abandoned_carts",
    {
      id: uuid("id")
...
export const utmTracking = checkoutSchema
  .table(
    "utm_tracking",
    {
      id: uuid("id")
...
// checkout.ab_tests
export const abTests = checkoutSchema
  .table(
    "ab_tests",
    {
      id: uuid("id")
      ...
      variantAConversions: integer("variant_a_conversions")
        .notNull()
        .default(0),
      variantBConversions: integer("variant_b_conversions")
        .notNull()
        .default(0),
